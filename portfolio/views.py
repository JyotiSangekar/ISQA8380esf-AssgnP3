...
def portfolio(request, pk):
    ...
    for stock in stocks:
        sum_current_stocks_value = sum_current_stocks_value + stock.current_stock_value()
        sum_of_initial_stock_value = sum_of_initial_stock_value + stock.initial_stock_value()

    portfolio_initial_investment = round(float(sum_of_initial_stock_value) + float(sum_acquired_value['acquired_value__sum']), 3);
    portfolio_current_investment = round(float(sum_current_stocks_value) + float(sum_recent_value['recent_value__sum']), 3);
