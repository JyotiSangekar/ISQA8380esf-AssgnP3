...
class InvestmentList(admin.ModelAdmin):
    list_display = ('customer', 'category', 'description','acquired_value','acquired_date',
                    'recent_value','recent_date','result')
...
class StockList(admin.ModelAdmin):
    list_display = ('customer','symbol', 'name', 'purchase_date','shares','purchase_price',
                    'initial_stock_value','current_stock_price','current_stock_value','result')
